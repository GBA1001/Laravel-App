...
<a href="{{url('edit', $getPostRecord->id)}}"><button type="submit">Edit Post</button></a>
</header>
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">{{$getPostRecord->title}}</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        {{$getPostRecord->description}}
                                    </p>
                                </div>
                                <p class="mt-4 text-sm/relaxed">
                                        {{$getPostRecord->view_count}}
                                </p>
