...
<div class="container">
    <main>
        <h2 class="mb-4 row justify-content-center text-white">Create a new post</h2> <!-- Added heading -->
            ...
            <div class="col-md-8">
                <form method="POST" action="{{ url('post/save') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="content" name="content" class="form-control text-editor" placeholder="Enter Content"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="category" name="category" type="text" class="form-control" placeholder="Enter Category">
                    </div>
